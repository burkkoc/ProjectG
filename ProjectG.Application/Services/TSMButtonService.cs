    ...
    public static class TSMButtonService
    {
        ...
        public static TSMButton CreateTSMButton(ButtonName name, Rectangle border, Rectangle tsmWindowBorder, ButtonContainer buttonContainer)
        {
            ...
            TSMButton tsmButton = new TSMButton
            {
                ...
                X = finalRectangle.X,
                Y = finalRectangle.Y,
                AbsoluteX = ScreenService.CalculateAbsolutePositionX(UtilityService.RandomClickCoordinateInRange(finalRectangle.X, finalRectangle.X + finalRectangle.Width), UserInput.ScreenResolutionX),
                AbsoluteY = ScreenService.CalculateAbsolutePositionY(UtilityService.RandomClickCoordinateInRange(finalRectangle.Y, finalRectangle.Y + finalRectangle.Height), UserInput.ScreenResolutionY),
                Clickable = true,
